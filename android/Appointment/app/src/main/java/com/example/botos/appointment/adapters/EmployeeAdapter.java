...
public class EmployeeAdapter extends RecyclerView.Adapter<EmployeeAdapter.ViewHolder> {
    ...
    public EmployeeAdapter(Context context, List<EmployeeModel> contactList) {
        this.mList = contactList;
        mContext = context;
    }

    public void update(List<EmployeeModel> list) {
        this.mList = list;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        final EmployeeModel rowModel = mList.get(position);
