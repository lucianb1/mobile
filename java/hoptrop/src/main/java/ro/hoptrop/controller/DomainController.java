...
public class DomainController {
    ...
    public DomainsJsonResponse getCompanyDomains(@AuthenticationPrincipal PrincipalUser user) {
        user.getAuthorities().forEach(item -> System.out.println(item.getAuthority()));
